...
class DNANet(nn.Module):
    def __init__(self, num_classes, input_channels, block, num_blocks, nb_filter,deep_supervision=False):
        ...
        #ffd
        self.ffd_4 = ffd(nb_filter[3], nb_filter[4], nb_filter[3])
        self.ffd_3 = ffd(nb_filter[2], nb_filter[3], nb_filter[2])
        self.ffd_2 = ffd(nb_filter[1], nb_filter[2], nb_filter[1])
        self.ffd_1 = ffd(nb_filter[0], nb_filter[1], nb_filter[0])
    ...
    def forward(self, input):
        ...
        mask3 = self.ffd_4(x3_1, x4_0)
        mask2 = self.ffd_3(x2_2, mask3)
        mask1 = self.ffd_2(x1_3, mask2)
        mask0 = self.ffd_1(x0_4, mask1)
        mask = self.ffd_0(x0_0, mask0)
