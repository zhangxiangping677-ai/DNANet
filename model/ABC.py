...
class DNANet(nn.Module):
    def __init__(self, num_classes, input_channels, block, num_blocks, nb_filter,deep_supervision=False):
        ...
        self.conv3_1 = self._make_layer(block, nb_filter[3],  nb_filter[3], num_blocks[2])
    ...
    def forward(self, input):
        ...
        x3_1 = self.conv3_1(x3_0)

        x4_0 = self.conv4_0(self.pool(x3_0))
        x4_1 = self.conv4_1(x4_0)

        mask0 = self.up_16(self.conv0_4_1x1(x4_1))
        mask1 = self.up_8(self.conv0_3_1x1(x3_1))
        mask2 = self.up_4 (self.conv0_2_1x1(x2_1))
        mask3 = self.up  (self.conv0_1_1x1(x1_1))

        Final_x0_4 = self.conv0_4_final(
            torch.cat([mask0, mask1, mask2, mask3, x0_1], 1))
